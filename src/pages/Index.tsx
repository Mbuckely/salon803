  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Salon 803 delivers professional hair care and modern styling in North Houston—quality styles at affordable prices. Book traditional sew-ins, silk press, blow outs and more." />
        ...
        <meta property="og:description" content="Professional hair care and modern styling at fair prices. Sew-ins, silk press, blow outs, wig installs and more." />
        <meta property="og:image" content="https://storage.googleapis.com/gpt-engineer-file-uploads/lNSXR17kHEfQO3VLkRaOzo1pySM2/uploads/1761006518131-salon803.jpg" />
        ...
        <meta name="twitter:image" content="https://storage.googleapis.com/gpt-engineer-file-uploads/lNSXR17kHEfQO3VLkRaOzo1pySM2/uploads/1761006518131-salon803.jpg" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "HairSalon",
            "name": "Salon 803",
            "image": "https://storage.googleapis.com/gpt-engineer-file-uploads/lNSXR17kHEfQO3VLkRaOzo1pySM2/uploads/1761006518131-salon803.jpg",
            "address": {
              "@type": "PostalAddress",
        ...
        <section id="hero" className="hero-section" aria-label="Salon 803 hero">
          ...
          <div className="hero-content">
            ...
            <p className="hero-subtitle">
              Flawless styles and full-service hair care without the hassle or high cost. Delivering quality styles at affordable prices.
            </p>
            <button className="btn btn-cta" onClick={() => scrollToSection('mission')}>Start Your Journey</button>

            <nav className="social-links" aria-label="Salon 803 social links">
              <a href="https://instagram.com/Salon803Houston" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              ...
              <a href="https://www.snapchat.com/add/Salon803Houston" target="_blank" rel="noopener noreferrer" aria-label="Snapchat">
              ...
              <a href="https://www.facebook.com/p/Salon803Houston-61578972822900/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true" focusable="false">
      ...
      <main id="main">
        <section id="mission" className="section" aria-labelledby="mission-title">
          <div className="container">
            ...
            <p className="section-text">
              ...
              We're an innovative and up-and-coming salon dedicated to providing flawless styles and full-service hair care without the hassle or high cost.
            </p>
            <div className="section-cta">
              <button className="btn btn-cta" onClick={() => scrollToSection('passion')}>Our Passion</button>
            </div>
          </div>
        </section>
        ...
        <section id="passion" className="section" aria-labelledby="passion-title">
          <div className="container">
            ...
            <p className="section-text">
              At Salon 803, we love all things beauty. Our passion for the industry has made us a trusted destination for modern hair care, custom styling, and expert service.
            </p>
            <div className="section-cta">
              <button className="btn btn-cta" onClick={() => scrollToSection('services')}>Explore Our Services</button>
            </div>
          </div>
        </section>
        ...
        <section id="services" className="section gradient-section" aria-labelledby="services-title">
          <div className="container-wide">
            <h2 id="services-title" className="section-title">Featured Services</h2>
        ...
        <section id="location" className="section" aria-labelledby="location-title">
          <div className="container">
            <h2 id="location-title" className="section-title">Our Location</h2>
            <p className="section-text">
              Visit us in the heart of North Houston! Salon 803 is conveniently located for clients across the area.
            </p>
            <div className="location-card">
              <svg className="icon-primary" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true" focusable="false">
            ...
            <div className="section-cta">
              <button className="btn btn-cta" onClick={openDirections}>Get Directions</button>
            </div>
          </div>
        </section>
        ...
        <section id="join-team" className="section gradient-section" aria-labelledby="join-title">
          <div className="container">
            ...
            <p className="section-text">
              Are you a passionate stylist or braider looking for a fresh start in a supportive and professional salon? We're growing — come join us.
            </p>
          ...
          <div className="container">
            ...
            <div className="contact-grid" role="list">
              <div className="contact-card" role="listitem">
                ...
                <h3>Address</h3>
                <p>4444 Cypress Creek Parkway<br />STE 30<br />Houston, TX 77068</p>
              </div>
              ...
              <div className="contact-card" role="listitem">
                ...
                <h3>Phone</h3>
                <p><a href="tel:+18326572126">(832) 657-2126</a></p>
              </div>
              ...
              <div className="contact-card" role="listitem">
                ...
                <h3>Email</h3>
                <p><a href="mailto:info@salon803.com">info@salon803.com</a></p>
              </div>
            </div>

            <div className="contact-buttons">
              <button className="btn btn-cta" onClick={handleCall}>Call Now</button>
              <button className="btn btn-primary" onClick={handleEmail}>Email Us</button>
              <button className="btn btn-secondary" onClick={openDirections}>Get Directions</button>
            </div>
          </div>
        </section>
      </main>
