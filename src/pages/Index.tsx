        ...
        <section id="mission" className="section" aria-labelledby="mission-title">
          <div className="container">
            ...
            <p className="section-text">
              Welcome to Salon 803, North Houston&apos;s newest go-to destination for quality hair care at prices you
              can afford. We&apos;re an innovative and up-and-coming salon dedicated to providing flawless styles and
        ...
        <section id="services" className="section gradient-section" aria-labelledby="services-title">
          <div className="container-wide">
            ...
            <div className="see-more-container" style={{ textAlign: "center", marginTop: "2rem" }}>
              {/* IMPORTANT: router link, not a static file link */}
      ...
      <footer className="footer">
        <div className="container">
          <p className="footer-copy">
            © <span id="currentYear">{new Date().getFullYear()}</span> Salon 803. All rights reserved.
          </p>
        </div>
      </footer>
    </>
