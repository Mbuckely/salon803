...
const Index = () => {
  ...
  <section id="mission" className="section" aria-labelledby="mission-title">
    <div className="container">
      ...
      <p className="section-text">
        <strong>Salon 803</strong> — Affordable styles • Full hair services • Walk-ins welcome.
        We bring North Houston quality hair care without the high price tag.
      </p>
      ...
      <p className="section-text" style={{ marginTop: '0.5rem' }}>
        Looking for stylish hair without the high price tag? Salon 803 offers sew-ins, custom styles,
        and full-service hair care — all at affordable prices.
      </p>
  ...
  <section id="passion" className="section" aria-labelledby="passion-title">
    <div className="container">
      ...
      <p className="section-text">
        We love all things beauty. From sew-ins and custom styles to full-service hair care,
        our team delivers modern techniques, attentive service, and results that inspire confidence — at prices that make great hair accessible.
      </p>
      <div className="section-cta">
